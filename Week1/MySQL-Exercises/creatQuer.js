...
app.get('/invitations', (req, res) => {
  ...
  dp.query(sql, [invite], (err, result) => {
    if (err) {
      throw err;
    }
    console.log(result);
...
app.get('/meetings', (req, res) => {
  let meeting = [
    [11, 'tranning', '2019-04-06 10:10:23', '2019-04-06 11:10:23', 12],
    [14, ' intro', '2019-07-07 14:10:00', '2019-07-07 16:10:00', 40],
    [29, 'breafing', '2019-08-02 10:40:00', '2019-08-02 13:40:00', 3],
    [30, 'consolting', '2019-09-07 13:00:00', '2019-09-07 15:00:00', 5],
    [58, 'cebration', '2019-11-07 09:10:00', '2019-11-07 12:10:00', 9],
  ];
  let sql =
    'INSERT INTO Meeting (meeting_no , meeting_title , starting_time , ending_time , room_no ) VALUES ?';
  dp.query(sql, [meeting], (err, result) => {
    if (err) {
      throw err;
    }
    console.log(result);
